...
class XyesjyApplicationTests {
    ...
    static void CreateCode(){
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/esjy?useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true&serverTimezone=GMT");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setDbType(DbType.MYSQL);
        dsc.setPassword("091834byh");
        mpg.setDataSource(dsc);

        // 包配置
        final PackageConfig pc = new PackageConfig();
        // pc.setModuleName(scanner("模块名"));
        pc.setParent("com.yi.xyesjy");
